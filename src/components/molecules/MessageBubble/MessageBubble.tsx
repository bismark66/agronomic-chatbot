import { Paper, Group, Avatar, Text, Badge, Alert, Table, Image, Stack } from '@mantine/core';
import { IconUser, IconRobot, IconInfoCircle, IconAlertTriangle, IconX, IconCheck } from '@tabler/icons-react';
        ...
        >
          <Stack gap="md">
            ...
            {message.metadata?.tableData && (
              <Stack gap="xs">
                <Text fw={500} size="sm">Agricultural Data:</Text>
                <Table striped highlightOnHover>
                  <Table.Thead>
                    <Table.Tr>
                      {message.metadata.tableData.headers.map((header, index) => (
            ...
            {message.metadata?.alertLevel && (
              ...
              >
                <Text size="sm">
                  This recommendation requires {message.metadata.alertLevel === 'error' ? 'immediate' : 'careful'} attention.
                </Text>
              </Alert>
            )}
          </Stack>
